                ...
                <div class="container mx-auto px-4 sm:px-8">
                    <div class="py-8">
                        <div class="my-2 flex sm:flex-row flex-col flex-no-wrap">
                            <form method="GET" action="{{ route('reserve.create') }}">
                                @csrf
                            ...
                            <form method="POST" action="{{ route('reserve.search') }}" class="flex sm:flex-row flex-col">
                                @csrf
                                            ...
                                            <tr>
                                                        ...
                                                        <div class="ml-3">
                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                @foreach( $doctors as $doctor)
                                                                    {{ $reserve->id_doctor == $doctor->id ? $doctor->name : '' }}
                                                                @endforeach
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="ml-3">
                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                @foreach( $rooms as $room)
                                                                    {{ $reserve->id_room == $room->id ? $room->number : '' }}
                                                                @endforeach
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <div class="flex items-center">
                                                        <div class="ml-3">
                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                {{ date('d-m-Y', strtotime($reserve->lease_date)) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <div class="flex items-center">
                                                        <div class="ml-3">
                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                {{ $reserve->available == '1' ? 'Reservado' : 'Disponível' }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                ...
                                <div
                                    class="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between ">
                                        <span class="text-xs xs:text-sm text-gray-900">
                                            @if(isset($filters))
                                                {{  $reserves->appends($filters)->links() }}
                                            @else
                                                {{  $reserves->links() }}
                                            @endif
                                        </span>
